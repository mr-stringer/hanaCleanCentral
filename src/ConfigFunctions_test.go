...
func TestGetConfigFromFile(t *testing.T) {
	...
	tests := []struct {
		...
		{"GoodFile01", args{lc, "testFiles/configtest01.json"}, &Config{true, 60, true, 60, true, true, 60, true, true, 60, []DbConfig{{"systemdb_TST", "hanadb.mydomain.int", 30015, "sstringer", "ReallzyKoolPassw0rd", true, 60, true, 60, true, true, 60, true, true, 60}}}, false},
		{"GoodFile02", args{lc, "testFiles/configtest02.json"}, &Config{true, 60, true, 60, true, true, 60, true, true, 60, []DbConfig{{"systemdb_TST", "hanadb.mydomain.int", 30015, "sstringer", "ReallzyKoolPassw0rd", true, 60, true, 60, true, true, 60, true, true, 60}, {"Ten01_TST", "hanadb.mydomain.int", 30041, "sstringer", "ReallzyKoolPassw0rd", true, 60, true, 60, true, true, 60, true, false, 0}}}, false},
		...
		{"NoDbPassword", args{lc, "testFiles/NoDbPassword.json"}, &Config{true, 60, true, 60, true, true, 60, true, true, 60, []DbConfig{{"systemdb_TST", "hanadb.mydomain.int", 30015, "sstringer", "", true, 60, true, 60, true, true, 60, true, true, 60}}}, false},
		...
		{"NoDbUsername", args{lc, "testFiles/NoDbUsername.json"}, &Config{}, true},
		{"DbOveride", args{lc, "testFiles/DbOverride.json"}, &Config{false, 0, false, 0, false, false, 0, false, false, 0, []DbConfig{{"systemdb_TST", "hanadb.mydomain.int", 30015, "sstringer", "ReallzyKoolPassw0rd", true, 30, true, 30, true, true, 30, true, true, 30}}}, false},
